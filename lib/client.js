...
window.__ModuleLoader__.load({
    ...
    factory: (require) => {
        ...
        function SettingsPanel(props) {
            ...
            return React.createElement("div", { className: "dsh-quota-settings" }, React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, "显示供应商"), visibilityRows.length ? visibilityRows : React.createElement("div", { className: "dsh-setting-hint" }, "（未配置供应商）")), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, "刷新间隔"), React.createElement("div", { className: "dsh-setting-row" }, React.createElement("span", { className: "dsh-setting-name" }, "自动刷新"), React.createElement("select", {
                className: "dsh-setting-select",
                value: refreshValue,
                onChange: function (event) { setRefresh(event.target.value); }
            }, REFRESH_CHOICES.map(function (choice) {
                return React.createElement("option", { key: choice.value || "follow", value: choice.value }, choice.value === "" ? choice.label + "（" + Math.round(specs.refreshMs / 1000) + " 秒）" : choice.label);
            })))), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, "代理"), React.createElement("div", { className: "dsh-setting-hint", style: { marginBottom: "4px" } }, "填写 http(s) 代理 URL，仅该供应商经此代理查询"), proxyRows.length ? proxyRows : null), React.createElement("div", { className: "dsh-setting-section" }, React.createElement("div", { className: "dsh-setting-title" }, "预警阈值"), thresholdRows.filter(Boolean).length ? thresholdRows : null), React.createElement("div", { className: "dsh-setting-actions" }, React.createElement("span", { className: "dsh-setting-hint" }, "设置仅保存在本浏览器"), React.createElement("button", { className: "dsh-setting-reset", type: "button", onClick: onReset }, "恢复默认")));
        }
        ...
        function apply(ctx) {
            ...
            function QuotaPanel() {
                ...
                if (!expanded) {
                    ...
                    return React.createElement("div", { id: "dsh-quota-panel" }, React.createElement("button", {
                ...
                if (settingsOpen) {
                    ...
                    if (fetchedAt !== null) {
                        ...
                        bodyChildren.push(React.createElement("div", { key: "at-text", className: "dsh-usage-caption" }, "更新于 " + new Date(fetchedAt).toLocaleTimeString()));
                    }
                }
                return React.createElement("div", { id: "dsh-quota-panel" }, React.createElement("div", { id: "dsh-quota-card" }, React.createElement("div", { className: "dsh-quota-header" }, React.createElement("div", { className: "dsh-quota-title" }, "模型额度"), React.createElement("div", { className: "dsh-quota-actions" }, React.createElement("button", {
            ...
            ctx.slots.inject("shell.overlay", () => ctx.slots.register({ name: "shell.overlay", id: "dsh-quota-panel", order: 100, label: "模型额度" }, () => React.createElement(QuotaPanel, null)));
        }
        exports.apply = apply;
