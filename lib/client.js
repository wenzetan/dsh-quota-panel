    ...
    factory: (require) => {
        ...
        function apply(ctx) {
            ...
            function QuotaPanel(props) {
                ...
                return React.createElement("div", { id: "dsh-quota-panel" }, React.createElement("div", { id: "dsh-quota-card" }, React.createElement("div", { className: "dsh-quota-header" }, React.createElement("div", { className: "dsh-quota-title" }, t("title")), React.createElement("div", { className: "dsh-quota-actions" }, React.createElement("button", {
