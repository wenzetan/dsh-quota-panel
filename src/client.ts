...
(window as any).__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS = [
			...
			'#dsh-quota-card .dsh-quota-header{display:flex;align-items:center;justify-content:space-between;min-height:24px;margin-bottom:13px;cursor:grab;user-select:none;touch-action:none}',
